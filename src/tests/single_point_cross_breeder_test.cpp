...
TEST(SinglePointCrossBreeder, Test1)
{
    ...
    EXPECT_EQ(ind1.at(0).get(), 0x0F);
    EXPECT_EQ(ind2.at(0).get(), 0xF0);
}
...
TEST(SinglePointCrossBreeder, Test2)
{
    ...
    EXPECT_EQ(ind1.at(0).get(), 0x0000);
    EXPECT_EQ(ind1.at(1).get(), 0x00FF);
    EXPECT_EQ(ind1.at(2).get(), 0xFFFF);
    EXPECT_EQ(ind2.at(0).get(), 0xFFFF);
    EXPECT_EQ(ind2.at(1).get(), 0xFF00);
    EXPECT_EQ(ind2.at(2).get(), 0x0000);
}
...
TEST(SinglePointCrossBreeder, Test3)
{
    ...
    EXPECT_EQ(ind1.at(0).get(), 0x07);
    EXPECT_EQ(ind1.at(1).get(), 0xFF);
    EXPECT_EQ(ind2.at(0).get(), 0xF8);
    EXPECT_EQ(ind2.at(1).get(), 0x00);
}
...
TEST(SinglePointCrossBreeder, Test4)
{
    ...
    EXPECT_EQ(ind1.at(0).get(), 0x0000'0000);
    EXPECT_EQ(ind1.at(1).get(), 0x0000'000F);
    EXPECT_EQ(ind2.at(0).get(), 0xFFFF'FFFF);
    EXPECT_EQ(ind2.at(1).get(), 0xFFFF'FFF0);
}